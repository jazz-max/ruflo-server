...
Ruflo — встроенная в Claude Code платформа для оркестрации AI-агентов. Включает семантическую память с векторными эмбеддингами, обучение на паттернах, координацию задач и кросс-проектный поиск знаний.
